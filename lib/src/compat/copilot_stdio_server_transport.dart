...
final class CopilotCompatStdioServerTransport implements Transport {
  CopilotCompatStdioServerTransport({Stdin? stdin, IOSink? stdout})
      : _stdin = stdin ?? requestStdin(),
        _stdout = stdout ?? requestStdout(),
        _logger = logging.Logger('CopilotCompatStdioServerTransport');

  static Stdin requestStdin() => stdin;
  static IOSink requestStdout() => stdout;
